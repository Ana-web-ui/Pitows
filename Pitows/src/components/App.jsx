...
function App() {
  return (
    <div className="App">
      ...
      <Title />
      <Section
        title={"O que são peças sob medida?"}
        content={
        ...
        content_right={true}
        img_path={"./src/img/made-page.png"}
      />
      ...
      <div className="section-bg">
        <Section
          title={"Ajustes"}
          content={
            "Além das peças sob medida, a Pitows oferece ajustes de alta qualidade para peças pré-prontas, garantindo que cada detalhe se adapte perfeitamente ao corpo de quem veste. Nosso serviço de ajustes é minucioso e preciso, transformando qualquer peça em uma extensão do estilo pessoal do cliente. Com dedicação e técnica, asseguramos conforto e elegância em cada ajuste."
          }
          content_right={false}
          img_path={"./src/img/made-page-2.png"}
        />
      </div>
      ...
      <Section
        ...
        content_right={true}
        img_path={"./src/img/made-page-3.png"}
      />
